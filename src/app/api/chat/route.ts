  ...
  try {
    ...
    if (conversation_id) {
      ...
      await supabase.from('messages').insert([
        { conversation_id: conversation_id, user_id: userId, role: 'user', content: userText },
        { conversation_id: conversation_id, user_id: userId, role: 'assistant', content: assistantText }
      ])
